...
\todo{figura do circuito ir a TV}
...
Com todos os componentes dimensionados é possível observar o circuito pré-\textit{layout}, Figura \todo{fazer o circuito na tv}. É possível reparar que a disposição do circuito foi modificada de modo a que o \textit{layout} não apresentasse sobreposições.

O \textit{layout} extraído do programa ADS pode ser observado na Figura \todo{por aqui o layout}, no entanto, na Figura \todo{layout com coisas do paint a dizer onde se liga o quê} é possível observar o \textit{layout} com informações detalhadas sobre a disposição dos componentes do circuito.
