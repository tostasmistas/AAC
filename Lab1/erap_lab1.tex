...
\vspace{1mm}
Tendo escolhido valores que correspondam a condensadores e bobines que existam no mercado, o valor de $C_{D}$ é de 1.3 pF e o valor de $L_{CHK}$ é de 3.9 nH. \todo{o valor de CD agora nao bate certo com a eq 2.5}
...
Em primeiro lugar substitui-se ambas as bobines por dispositivos que utilizem a tecnologia de microfita, ambas as bobines com as suas fontes de tensão terão de ser substituídas pelo bloco demonstrado na Figura \ref{fig:bobine}. \todo{this sentence is weird}
