...
O processador elaborado foi simulado para uma placa Artix 7 \todo{ver pins da placa e etc para justificar decisao}

O $\mu$Risc projectado tem as seguintes características:
...
\begin{itemize}
  ...
  \vspace{-2.5mm}
  \item uma memória ROM de 4K endereçada com palavras de 12 \textit{bits} utilizada para as instruções/programa e uma memória RAM de 4K endereçada com palavras de 16 \textit{bits} para os dados.
