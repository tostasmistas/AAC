...
\begin{table}[H]
	\centering
	\caption{Parâmetros experimentais que definem o transístor.}
	\vspace{-1.5mm}
...
\todo{corrigi esta equacao do condensador, julgo que o sinal de menor estava mal e isso afecta o valor do condensador}
