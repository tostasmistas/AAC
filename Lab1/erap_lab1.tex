...
\begin{figure}[H]
	\centering
	\includegraphics[keepaspectratio=true, scale=0.41]{exps/descont_S_pos_tune}
	\vspace{-0.5em}
...
\begin{figure}[H]
	\centering
	\includegraphics[keepaspectratio=true, scale=0.41]{exps/descont_estab_pos_tune}
	\vspace{-0.5em}
...
Como se pode observar na Figura \ref{fig:descont_estab_pos_tune}, o parâmetro de estabilidade para 22 GHz apresenta um valor que garante a estabilidade incondicional do amplificador para 22GHz. Como se pode observar, apenas se pode garantir a estabilidade incondicional numa banda que vai de aproximadamente 15 GHz a 30 GHz. No entando, foi realizada uma nova simulação para determinar a estabilidade do amplificador em banda larga, que pode ser vista na Figura \ref{fig:descont_smith_pos_tune}. 

\begin{figure}[H]
	\centering
	\includegraphics[keepaspectratio=true, scale=0.41]{exps/descont_smith_pos_tune}
	\vspace{-0.5em}
	\caption{Estabilidade do amplificador com descontinuidades simuladas pós-\texttt{TUNE}.}
	\vspace{-0.8em}
	\label{fig:descont_smith_pos_tune}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[keepaspectratio=true, scale=0.41]{exps/descont_noise_pos_tune}
	\vspace{-0.5em}
...
\begin{table}[H]
	...
	\vspace{-1.5mm}
	\includegraphics[keepaspectratio=true, scale=0.41]{exps/compfinal}
